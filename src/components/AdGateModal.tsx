...
const PARTNERS = {
  ...
  pickbook: {
    url: 'https://herhealthng.vercel.app',
    name: 'HerHealth',
    icon: '💞',
    desc: 'Track your period, symptoms, flow, energy levels and mood with a calm, intuitive dashboard.',
  },
}
        ...
        {step === 1 && (
          <div>
            ...
            <p className="modal-desc">
              ...
              After <strong>5 downloads</strong>, the ad gate is permanently removed for your device.
            </p>
